...
import {
    Heart, Briefcase, Brain, Users, Zap, Frown,
    Flame, ShieldAlert, TrendingUp, Coffee,
...
const CategorySelection = () => {
    ...
    const categories = [
        ...
        { id: 'founder_pressure', label: 'Founder Pressure', icon: Coffee, color: 'bg-amber-100 text-amber-600' },
        { id: 'burnout', label: 'Burnout', icon: Flame, color: 'bg-red-100 text-red-600' },
        { id: 'staff_conflict', label: 'Staff Conflict', icon: MessageSquare, color: 'bg-indigo-100 text-indigo-600' },
        { id: 'performance_anxiety', label: 'Performance Anxiety', icon: TrendingUp, color: 'bg-green-100 text-green-600' },
        { id: 'gbv', label: 'GBV Support', icon: ShieldAlert, color: 'bg-rose-100 text-rose-600' },
        ...
        { id: 'financial', label: 'Financial Stress', icon: Banknote, color: 'bg-emerald-100 text-emerald-600' },
    ];
